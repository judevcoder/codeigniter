...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo base_url(); ?>new/_auth.scss">
   <style type="text/css">
    ...
    background-image: url(http://blog.bookbaby.com/wp-content/uploads/2015/11/What-Makes-A-Book-Banner.jpg);
}
